  ...
  return (
    <FormControl error={gender.error} component="fieldset">
      ...
      <RadioGroup 
        ...
        <FormControlLabel value="male" control={<Radio />} label={<Typography fontSize="1.2rem" fontWeight="bold" color="secondary"><MaleTwoTone fontSize="inherit" /> ذكر</Typography>} />
        <FormControlLabel value="female" control={<Radio />} label={<Typography fontSize="1.2rem" fontWeight="bold" color="secondary"><FemaleTwoTone fontSize="inherit" /> إنثى</Typography>} />
      </RadioGroup>
